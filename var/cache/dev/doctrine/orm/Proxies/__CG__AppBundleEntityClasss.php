 ...
 */
class Classs extends \AppBundle\Entity\Classs implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Classs' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Classs' . "\0" . 'cTitle', '' . "\0" . 'AppBundle\\Entity\\Classs' . "\0" . 'classTeacher', '' . "\0" . 'AppBundle\\Entity\\Classs' . "\0" . 'user', '' . "\0" . 'AppBundle\\Entity\\Classs' . "\0" . 'scores', '' . "\0" . 'AppBundle\\Entity\\Classs' . "\0" . 'scoreChildren', '' . "\0" . 'AppBundle\\Entity\\Classs' . "\0" . 'students', '' . "\0" . 'AppBundle\\Entity\\Classs' . "\0" . 'examCompanies'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Classs $proxy) {
    ...
    public function setCTitle($cTitle)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCTitle', [$cTitle]);

        return parent::setCTitle($cTitle);
    }
    ...
    public function getCTitle()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCTitle', []);

        return parent::getCTitle();
    }
    ...
    public function setClassTeacher($classTeacher)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setClassTeacher', [$classTeacher]);
    ...
    public function getClassTeacher()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getClassTeacher', []);
