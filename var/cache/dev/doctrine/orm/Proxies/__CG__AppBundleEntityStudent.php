...
class Student extends \AppBundle\Entity\Student implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Student' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Student' . "\0" . 'names', '' . "\0" . 'AppBundle\\Entity\\Student' . "\0" . 'gender', '' . "\0" . 'AppBundle\\Entity\\Student' . "\0" . 'upi_number', '' . "\0" . 'AppBundle\\Entity\\Student' . "\0" . 'user', '' . "\0" . 'AppBundle\\Entity\\Student' . "\0" . 'class', '' . "\0" . 'AppBundle\\Entity\\Student' . "\0" . 'scores', '' . "\0" . 'AppBundle\\Entity\\Student' . "\0" . 'scoreChildren'];
        }
    ...
    public function setUpiNumber($upiNumber)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setUpiNumber', [$upiNumber]);

        return parent::setUpiNumber($upiNumber);
    }
    ...
    public function getUpiNumber()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getUpiNumber', []);

        return parent::getUpiNumber();
    }
