 ...
 */
class Subject extends \AppBundle\Entity\Subject implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Subject' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Subject' . "\0" . 'sTitle', '' . "\0" . 'AppBundle\\Entity\\Subject' . "\0" . 'user', '' . "\0" . 'AppBundle\\Entity\\Subject' . "\0" . 'childSubjects', '' . "\0" . 'AppBundle\\Entity\\Subject' . "\0" . 'scores', '' . "\0" . 'AppBundle\\Entity\\Subject' . "\0" . 'scoreChildren'];
        }
    ...
    public function setSTitle($sTitle)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSTitle', [$sTitle]);

        return parent::setSTitle($sTitle);
    }
    ...
    public function getSTitle()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSTitle', []);

        return parent::getSTitle();
    }
